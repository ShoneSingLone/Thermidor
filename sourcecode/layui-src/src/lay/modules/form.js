      ...
      items = {
        ...
        select: function () {
            ...
            selects.each(function (index, select) {
              //原始的select dom结构
              console.log("select DOM", this);
              //jQuery 对象
              var $select = $(this);
              var hasRender = $select.next('.' + CLASS);
